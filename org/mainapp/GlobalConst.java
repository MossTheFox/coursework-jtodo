...
public class GlobalConst {
    ...
    * */
    ...
    static String finishAuthenticationURL = mainAPIUrlPrefix + "/auth";

    // GET, body: { "code": "ok", "data": { "collections": [], "items": [] } }
    static String initialGetDataUrl = mainAPIUrlPrefix + "/data";

    // method: PATCH
    static String syncUrl = mainAPIUrlPrefix + "/data/sync";


    public static String versionText = "Alpha 0.1.8 (2022-06-19)";
